...
public class Pressure extends ContinuousCollector {

	protected static final String TAG = "Pressure";

	public Pressure(String filename, Context mContext) throws IOException {
	...
	public String[] GetReadingNames() {
		// TODO Auto-generated method stub
		return new String[]{"hPa (millibar)"};
	}
