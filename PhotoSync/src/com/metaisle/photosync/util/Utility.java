package com.metaisle.photosync.util;
...
public class Utility extends Application {
	...
	public static byte[] scaleImage(Context context, String filePath,
			int orientation, String type) throws IOException {
